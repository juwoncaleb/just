    ...
    <div className="project_sub">
      ...
      <div className="video_div">
        ...
        <motion.div
          ...
          >
 <p className="VIDEO_TEXT">SERVICES</p>
          <p className="mission mt-4">Corporate Initiative</p>
          <div className="corp">
          ...
          >
            <div className="testimonal_card">
              ...
              <p className="mb-8">
                ...
                responsibly recycling and repurposing electronic devices.
              </p>
            </div>  
          </motion.div>
          <motion.div
            ...
            <div className="grid proj_card gap-8 grid-cols-2">
              ...
              <div>
                ...
                <p className="lore">
                  ...
                  mission by sending them our way. Whether you are an individual
                  with a smartphone or a business with a surplus of laptops,
                  your contribution plays a vital role in reducing electronic
                  waste and empowering underserved communities.
                </p>
          ...
          >
              ...
              <div>
                ...
                <p className="lore">
                  ...
                  dispose of electronic devices. Through our corporate services,
                  we ensure the proper collection and repurposing of devices,
                  aligning your organization with environmental sustainability
                  practices.
                </p>
                <div className="lin"></div>
